...
public class PriceResourceIntTest {
    ...
    private static final Double DEFAULT_T_ONE = 1D;
    private static final Double UPDATED_T_ONE = 2D;

    private static final Double DEFAULT_T_TWO = 1D;
    private static final Double UPDATED_T_TWO = 2D;

    private static final Double DEFAULT_T_THREE = 1D;
    private static final Double UPDATED_T_THREE = 2D;
    ...
    public void initTest() {
        price = new Price();
        price.settOne(DEFAULT_T_ONE);
        price.settTwo(DEFAULT_T_TWO);
        price.settThree(DEFAULT_T_THREE);
    ...
    public void createPrice() throws Exception {
        ...
        assertThat(testPrice.gettOne()).isEqualTo(DEFAULT_T_ONE);
        assertThat(testPrice.gettTwo()).isEqualTo(DEFAULT_T_TWO);
        assertThat(testPrice.gettThree()).isEqualTo(DEFAULT_T_THREE);
    ...
    public void getAllPrices() throws Exception {
        ...
        restPriceMockMvc.perform(get("/api/prices"))
                ...
                .andExpect(jsonPath("$.[*].tOne").value(hasItem(DEFAULT_T_ONE.doubleValue())))
                .andExpect(jsonPath("$.[*].tTwo").value(hasItem(DEFAULT_T_TWO.doubleValue())))
                .andExpect(jsonPath("$.[*].tThree").value(hasItem(DEFAULT_T_THREE.doubleValue())))
    ...
    public void getPrice() throws Exception {
        ...
        restPriceMockMvc.perform(get("/api/prices/{id}", price.getId()))
            ...
            .andExpect(jsonPath("$.tOne").value(DEFAULT_T_ONE.doubleValue()))
            .andExpect(jsonPath("$.tTwo").value(DEFAULT_T_TWO.doubleValue()))
            .andExpect(jsonPath("$.tThree").value(DEFAULT_T_THREE.doubleValue()))
    ...
    public void updatePrice() throws Exception {
        ...
        // Update the price
        price.settOne(UPDATED_T_ONE);
        price.settTwo(UPDATED_T_TWO);
        price.settThree(UPDATED_T_THREE);
        ...
        Price testPrice = prices.get(prices.size() - 1);
        assertThat(testPrice.gettOne()).isEqualTo(UPDATED_T_ONE);
        assertThat(testPrice.gettTwo()).isEqualTo(UPDATED_T_TWO);
        assertThat(testPrice.gettThree()).isEqualTo(UPDATED_T_THREE);
