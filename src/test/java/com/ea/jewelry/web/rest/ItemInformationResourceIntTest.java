...
public class ItemInformationResourceIntTest {
    ...
    private static final String DEFAULT_ITEM_NUMBER = "AAAAA";
    private static final String UPDATED_ITEM_NUMBER = "BBBBB";
    private static final String DEFAULT_VENDOR_ITEM_NUMBER = "AAAAA";
    private static final String UPDATED_VENDOR_ITEM_NUMBER = "BBBBB";
