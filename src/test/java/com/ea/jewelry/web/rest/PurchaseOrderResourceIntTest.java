...
public class PurchaseOrderResourceIntTest {
    ...
    private static final String DEFAULT_P_ONUMBER = "AAAAA";
    private static final String UPDATED_P_ONUMBER = "BBBBB";
    ...
    public void initTest() {
        ...
        purchaseOrder.setpONumber(DEFAULT_P_ONUMBER);
    }
    ...
    public void createPurchaseOrder() throws Exception {
        ...
        assertThat(testPurchaseOrder.getpONumber()).isEqualTo(DEFAULT_P_ONUMBER);
    }
    ...
    public void getAllPurchaseOrders() throws Exception {
        ...
        restPurchaseOrderMockMvc.perform(get("/api/purchaseOrders"))
                ...
                .andExpect(jsonPath("$.[*].pONumber").value(hasItem(DEFAULT_P_ONUMBER.toString())));
    }
    ...
    public void getPurchaseOrder() throws Exception {
        ...
        restPurchaseOrderMockMvc.perform(get("/api/purchaseOrders/{id}", purchaseOrder.getId()))
            ...
            .andExpect(jsonPath("$.pONumber").value(DEFAULT_P_ONUMBER.toString()));
    }
    ...
    public void updatePurchaseOrder() throws Exception {
        ...
        purchaseOrder.setpONumber(UPDATED_P_ONUMBER);
        ...
        PurchaseOrder testPurchaseOrder = purchaseOrders.get(purchaseOrders.size() - 1);
        assertThat(testPurchaseOrder.getpONumber()).isEqualTo(UPDATED_P_ONUMBER);
    }
