...
angular.module('jewelryApp').controller('ItemInformationDialogController',
    ['$scope', '$stateParams', '$modalInstance', 'entity', 'ItemInformation', 'Item', 'User', 'Category',
        function($scope, $stateParams, $modalInstance, entity, ItemInformation, Item, User, Category) {
